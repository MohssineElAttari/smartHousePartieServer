//package com.elastamo.smarthousepartieserver.filter;
//
//import com.auth0.jwt.JWT;
//import com.auth0.jwt.algorithms.Algorithm;
//import com.elastamo.smarthousepartieserver.config.AuthRequest;
...
//        try {
//            req = new ObjectMapper().readValue(request.getInputStream(), AuthRequest.class);
//        } catch (IOException e) {
//            e.printStackTrace();
//        }
//
//        log.info("username is : {}",req.getUsername()); log.info("password is : {}",req.getPassword());
